...
function processCommits() {
  commits = d3.groups(data, (d) => d.commit).map(([commit, lines]) => {
    ...
    let ret = {
      id: commit,
      url: 'https://github.com/sohan-shingade/dsc106-portfolio/commit/' + commit,
      author,
      date,
      time,
      timezone,
...
function renderCommitInfo() {
  ...
  const stats = [
    ...
    { label: 'Avg line length', value: avgLineLength.toFixed(1) + ' chars' },
    { label: 'Max nesting depth', value: maxDepth },
